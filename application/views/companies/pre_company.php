<!-- Pre-Incorporation Company Listing -->
<div class="page-title">
    <div class="title_left">
        <h3>Pre-Incorporation Companies <small>(Total: <?= $total ?? 0 ?>)</small></h3>
    </div>
        ...
        <div class="x_panel">
            <div class="x_content">
                <div class="alert alert-info">
                    <i class="fa fa-info-circle"></i> Showing companies with <strong>Pre-Incorporation</strong> status.
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (!empty($c->is_non_client)): ?><span class="label label-danger">Non-Client</span><?php endif; ?>
                            </td>
                            ...
                            <td><span class="label label-warning"><?= htmlspecialchars($c->entity_status ?? 'Pre-Incorporation') ?></span></td>
